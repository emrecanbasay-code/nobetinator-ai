...
with tab_const:
    ...
    st.markdown("---")
    st.caption("**X** = Kesin İzin (Asla nöbet yazılmaz) | **S** = Esnek İzin (Zorda kalınca yazılabilir) | **24/16** = Sabit Nöbet|Buraya excelden kopyala yapıştır yapabilrsiniz X ve S büyük harf olacak")
